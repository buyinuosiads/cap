            ...
            if (sys_Role.Sort != null)
            {
                ...
                for (int i = 0; i < menu.Length; i++)
                {
                    ...
                    else if (num == "13")
                    {
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(box, Guid.NewGuid()));  //13
                    ...
                    else if (num == "14")
                    {
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(specifications, Guid.NewGuid()));  //14
                    ...
                    else if (num == "15")
                    {
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(supplier));  //15
                    ...
                    else if (num == "16")
                    {
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(custom));  //16
                    }
                    #endregion
                    ...
                    else if (num == "17")
                    {
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(inventory)); //17
                    }
                    else if (num == "18")
                    {
                        if (KCGL == false)
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(inbound));   //18
                    }
                    else if (num == "19")
                    {
                        if (KCGL == false)
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(outbound));  //19
                    }
                    #endregion
                    ...
                    else if (num == "20")
                    {
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(orderManagement)); //20
                    }
                    else if (num == "21")
                    {
                        if (DD == false)
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(orderSplitting));  //21
                    }
                    else if (num == "22")
                    {
                        if (DD == false)
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(orderAdditionalRecording));  //22
                    }
                    else if (num == "23")
                    {
                        if (DD == false)
                        ...
                        uiNavMenu1.CreateNode(AddPage(worker)); // 23
                    }
                    else if (num == "24")
                    {
                        if (DD == false)
                        ...
                        uiNavMenu1.CreateNode(AddPage(workRecords)); //24
                    }
                    #endregion
                    ...
                    else if (num == "25")
                    {
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(financialJournal)); //25
                    }
                    else if (num == "26")
                    {
                        if (CW == false)
                        ...
                        uiNavMenu1.CreateChildNode(parent, AddPage(financialStatements)); //26
                    }
                    else if (num == "27")
                    {
                        if (CW == false)
                        ...
                        uiNavMenu1.CreateNode(AddPage(attendanceManagement));  //27
                    }
                    else if (num == "28")
                    {
                        if (CW == false)
                        ...
                        uiNavMenu1.CreateNode(AddPage(purchasingManagement)); // 28
                    }
                    else if (num == "29")
                    {
                        if (CW == false)
                        ...
                        uiNavMenu1.CreateNode(AddPage(fixedAssets));  //29
                    }
                    else if (num == "30")
                    {
                        if (CW == false)
                        ...
                        uiNavMenu1.CreateNode(AddPage(alarmManagement)); //30
                    }
                    #endregion
                }
            }
